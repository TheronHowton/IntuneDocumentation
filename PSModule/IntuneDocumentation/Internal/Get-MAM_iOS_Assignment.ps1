Function Get-MAM_iOS_Assignment() {
    <#
        ...
        .DESCRIPTION
        The function connects to the Graph API Interface and gets the iOS MAM Assignments
        .EXAMPLE
        Get-MAM_iOS_Assignment -policyId $id
        Returns the iOS MAM Assignments configured in Intune
        .NOTES
